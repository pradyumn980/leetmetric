document.addEventListener("DOMContentLoaded",function(){
    ...
    function displayUserData(parseddata){
        ...
        updateProgress(solvedTotalEasyQues,totalEasyQuestion,easyLabel,easyProgressCircle);
        updateProgress(solvedTotalMediumQues,totalMediumQuestion,mediumLabel,mediumProgressCircle);
        updateProgress(solvedTotalHardQues,totalHardQuestion,hardLabel,hardProgressCircle);
